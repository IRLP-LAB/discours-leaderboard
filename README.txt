...
HOW TO USE
   ...
   $ perl scorer.pl all data/hi_gold_data.txt data/hi_sysrun_data.txt
   
   where:
     data/tl_gold_data.txt -- is the gold standard tagged file (also called as reference data)
     data/tl_sysrun_data.txt -- is the system run output file
     all -- it is a flag which needs to be given to get all the metric scores
